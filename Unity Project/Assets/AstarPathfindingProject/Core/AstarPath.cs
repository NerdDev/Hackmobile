...
public class AstarPath : MonoBehaviour
{
   ...
   */
    ...
    public static Queue<PFPath> pathQueue = new Queue<PFPath>();
    ...
    public static Stack<PFPath> PathPool;
    ...
    public static PFPath GetFromPathPool()
    {
        ...
        if (active.recyclePaths)
        {
            if (PathPool == null)
            {
                PathPool = new Stack<PFPath>(10);
                return new PFPath();
            }

            if (PathPool.Count > 0)
            {
                PFPath p = PathPool.Pop();
                return p;
            }
            else
            {
     ...
     */
    public static void AddToPathPool(PFPath p)
    {
        if (!active.recyclePaths)
        {
            return;
...
#line default
	 ...
	 */
    public void LogPathResults(PFPath p)
    {
    ...
    */
    ...
    public void OnDestroy()
    {
        ...
        PFPath p = pathReturnStack.PopAll();
        while (p != null)
        {
            p.error = true;
    ...
    *	 Debug.Log ("Scanning... " + progress.description + " - " + (progress.progress*100).ToString ("0") + "%");
    ...
    public static void StartPath(PFPath p)
    {
