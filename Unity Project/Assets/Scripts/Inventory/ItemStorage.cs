...
public class ItemStorage : MonoBehaviour
{
	...
	public List<Item> items { get { while (mItems.Count < maxItemCount) mItems.Add(null); return mItems; } }

	/// <summary>
	/// Convenience function that returns an item at the specified slot.
	/// </summary>

	public Item GetItem (int slot) { return (slot < items.Count) ? mItems[slot] : null; }
