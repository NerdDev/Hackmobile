...
[AddComponentMenu("NGUI/Interaction/Button Offset Toggle")]
public class UIButtonOffsetToggle : MonoBehaviour
{
    ...
    void OnClick()
    {
        ...
        if (on)
        {
            TweenPosition.Begin(tweenTarget.gameObject, duration, mPos + pressed).method = UITweener.Method.EaseInOut;
        }
        else
        {
