...
public class GUILabel : UIButton
{
    ...
    void OnClick()
    {
        ...
        {
            //Vector3 curPos = BigBoss.Gooey.ChatGrid.transform.localPosition;
            //Vector3 newPos = new Vector3(curPos.x, curPos.y + 500, curPos.z);
            //BigBoss.Gooey.ChatGrid.transform.localPosition = newPos;
            BigBoss.Gooey.ChatGrid.GridPanel.clipRange = new Vector4(50, -400, 500, 800);
            //BigBoss.Gooey.ChatGrid.ResetPosition();
