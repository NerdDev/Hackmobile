...
{
    private LevelLoadManager m_Instance = null;
    private Material m_Material = null;
    private string m_LevelName = "";
    private int m_LevelIndex = 0;
    private bool m_Fading = false;

    private LevelLoadManager Instance
    {
        get
        {
            if (m_Instance == null)
            {
                m_Instance = GameObject.Find("Managers").GetComponent("LevelManager") as LevelLoadManager;
            }
            return m_Instance;
        }
    }
