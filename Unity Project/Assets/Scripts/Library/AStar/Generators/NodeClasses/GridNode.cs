...
namespace Pathfinding.Nodes
{
    public class GridNode : Node
    {
        ...
        public override int[] InitialOpen(BinaryHeapM open, Int3 targetPosition, Int3 position, PFPath path, bool doOpen)
        {
        ...
        public override void Open(NodeRunData nodeRunData, NodeRun nodeR, Int3 targetPosition, PFPath path)
        {
