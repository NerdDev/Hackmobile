...
public class PillarMod : FillRoomMod
{
    ...
    static PillarMod()
    {
        //spacingOptions.Add(2, .15, false);
        spacingOptions.Add(3, .5, false);
    ...
    protected override bool ModifyInternal(RoomSpec spec)
    {
        ...
        var call = Draw.EmptyFloorNotBlocking<GenSpace>().IfThen(Draw.MergeIn(pillarSet, spec.Random, spec.Theme));
