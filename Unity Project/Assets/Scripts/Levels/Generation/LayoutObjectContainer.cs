...
//public class LayoutObjectContainer<T>
//    where T : IGridType
//{
//    protected List<ILayoutObject<T>> objects = new List<ILayoutObject<T>>();
//    protected Container2D<T> summaryGrid = new MultiMap<T>();
