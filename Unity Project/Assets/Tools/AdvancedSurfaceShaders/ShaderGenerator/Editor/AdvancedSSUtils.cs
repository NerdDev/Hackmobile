...
namespace AdvancedSS
{
    public class AdvancedShader
    {
        ...
        {
#if UNITY_EDITOR
            string relativeFilePath = System.IO.Path.Combine(directory, ShaderFileName());
            string filePath = System.IO.Path.Combine(Application.dataPath, relativeFilePath);
