...
namespace Pathfinding {
	...
	public interface IPathModifier {
		...
		void ApplyOriginal (PFPath p);
		void Apply (PFPath p, ModifierData source);
		void PreProcess (PFPath p);
	}
	...
	public abstract class Modifier : IPathModifier {
		...
		/** \deprecated */
		[System.Obsolete]
		public virtual void ApplyOriginal (PFPath p) {
		}
		
		/** Main Post-Processing function */
		public abstract void Apply (PFPath p, ModifierData source);
		
		/** \deprecated */
		[System.Obsolete]
		public virtual void PreProcess (PFPath p) {
		}
	}
	...
	public abstract class MonoModifier : MonoBehaviour, IPathModifier {
		...
		/** \deprecated */
		[System.Obsolete]
		public virtual Vector3[] GetNextTarget (PFPath p, Vector3 currentPosition) {
			return p.vectorPath;
			//Debug.Log ("Base call");
		}
	...
	public class ModifierConverter {
		...
		public static ModifierData Convert (PFPath p, ModifierData input, ModifierData output) {
