...
if AstarFree || !DefinedHeuristic
	...
	if NoHeuristic
		...
		*/
		...
		public virtual int[] InitialOpen (BinaryHeapM open, Int3 targetPosition, Int3 position, PFPath path, bool doOpen) {
			return BaseInitialOpen (open,targetPosition,position,path,doOpen);
		}
		
		public int[] BaseInitialOpen (BinaryHeapM open, Int3 targetPosition, Int3 position, PFPath path, bool doOpen) {
		...
		public virtual void Open (NodeRunData nodeRunData, NodeRun nodeR, Int3 targetPosition, PFPath path) {
		 ...
		 * \see #connections
		 * \see Open */
		public void BaseOpen (NodeRunData nodeRunData, NodeRun nodeR, Int3 targetPosition, PFPath path) {
