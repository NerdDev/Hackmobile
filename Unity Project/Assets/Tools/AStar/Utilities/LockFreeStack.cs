	...
	public class LockFreeStack {
		...
		public void Push (PFPath p) {
			...
			while (true) {
				...
				PFPath old = Interlocked.CompareExchange<PFPath>(ref head, p, p.next);
...
#else
			return Interlocked.Exchange<PFPath> (ref head, null);
#endif
		}
