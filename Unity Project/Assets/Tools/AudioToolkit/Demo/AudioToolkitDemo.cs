...
public class AudioToolkitDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        GUI.Label( new Rect( 22, 10, 300, 20 ), "ClockStone Audio Toolkit Free Version - Demo" );

        int ypos = 10;
        int yposOff = 35;

        GUI.Label( new Rect( 250, ypos + 30, 200, 30 ), "Global Volume" );

        AudioController.SetGlobalVolume( GUI.HorizontalSlider( new Rect( 250, ypos + 60, 200, 30 ), AudioController.GetGlobalVolume(), 0, 1 ) );
        ...
        GUI.Label( new Rect( 250, ypos + 30, 200, 30 ), "Music Volume" );

        float musicVolumeNew = GUI.HorizontalSlider( new Rect( 250, ypos + 60, 200, 30 ), musicVolume, 0, 1 );
